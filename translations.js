...
window.translations = {
    ua: {
        ...
        "#screen-2 .info-item:nth-child(2) .info-text": "12:00–23:00",
        ...
        ".leisure-bento-grid .bento-tile:nth-child(1) .tile-desc": "Трекінг-маршрути, прокат велосипедів і квадроциклів, Озеро Молодості, етнопарк «Гуцул Ленд» та прогулянки серед карпатських краєвидів.",
    ...
    en: {
        ...
        ".leisure-bento-grid .bento-tile:nth-child(1) .tile-header span": "Summer Activities",
        ".leisure-bento-grid .bento-tile:nth-child(1) .tile-desc": "Hiking trails, bike & ATV rentals, Lake of Youth, ethno-park 'Hutsul Land' and picturesque Carpathian walks.",
    ...
    ru: {
        ...
        ".leisure-bento-grid .bento-tile:nth-child(1) .tile-desc": "Треккинг-маршруты, прокат велосипедов и квадроциклов, Озеро Молодости, этнопарк «Гуцул Ленд» и прогулки среди карпатских пейзажей.",
